...
class MainWindow(QMainWindow):
    ...
    def _build_settings_group(self) -> QGroupBox:
        ...
        self.tts_service_combo.setFixedWidth(130)
        ...
        self.choose_whisper_model_file_button.setFixedWidth(110)
        self.choose_whisper_model_path_button.setFixedWidth(120)
